...
#### _An Application For Calculating Numbers, January 2020_

#### By _**Todd Walraven**_

## Description

_this application allows the user to input two numbers and then select whether they would like to add, subtract, multuply, or divide the inputted numbers_
